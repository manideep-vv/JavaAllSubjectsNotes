...
public class ProducerWithCommitAndAbort {
    public static void main(String[] args) {
        ...
        try{
            kafkaProducer.send(new ProducerRecord<>(topicName1,1,"Mesage-10")  );
            kafkaProducer.send(new ProducerRecord<>(topicName2,1,"Mesage-10")  );
            kafkaProducer.commitTransaction();
            System.out.println("sent 2 messages txn comitted");
        }catch (Exception e){
